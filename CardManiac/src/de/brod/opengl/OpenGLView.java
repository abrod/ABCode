...
public class OpenGLView extends GLSurfaceView implements GLSurfaceView.Renderer {
	...
	private ArrayList<Sprite<?>> _lstSprites;
	...
	public void onDrawFrame(GL10 gl) {
		synchronized (this) {
			...
			// System.out.println(Color.red(col) + "," + Color.green(col) + ","
			// + Color.blue(col) + "," + Color.alpha(col));
